...
config = {
    ...
    "image": "https://media.discordapp.net/attachments/1090988654673002606/1132396666520076418/image.png", # You can also have a custom image by using a URL argument
